...
CREATE TABLE `flw_cc_instance`  (
                                    ...
                                    `actor_id` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '参与者ID',
...
CREATE TABLE `flw_his_instance`  (
                                     ...
                                     `last_update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '上次更新人',
...
CREATE TABLE `flw_his_task`  (
                                 ...
                                 `task_state` tinyint(1) NOT NULL DEFAULT 0 COMMENT '任务状态 0，活动 1，结束 2，超时 3，终止',
                                 PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `flw_surrogate`  (
                                  ...
                                  `empower` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '授权人',
