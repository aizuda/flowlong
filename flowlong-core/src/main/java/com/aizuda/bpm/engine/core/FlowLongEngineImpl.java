...
public class FlowLongEngineImpl implements FlowLongEngine {
     ...
     */
    @Override
    public Optional<FlwInstance> startInstanceById(Long id, FlowCreator flowCreator, Map<String, Object> args, boolean saveAsDraft, Consumer<NodeModel> checkNodeModel, Supplier<FlwInstance> supplier) {
     ...
     */
    @Override
    public Optional<FlwInstance> startProcessInstance(FlwProcess process, FlowCreator flowCreator, Map<String, Object> args, boolean saveAsDraft,
                                                      Consumer<NodeModel> checkNodeModel, Supplier<FlwInstance> supplier) {
        // 执行启动模型
        return process.executeStartModel(flowLongContext, flowCreator, saveAsDraft, checkNodeModel, nodeModel -> {
