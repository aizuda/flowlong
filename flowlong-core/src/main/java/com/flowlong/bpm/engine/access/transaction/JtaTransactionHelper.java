...
public class JtaTransactionHelper {
    ...
    public static javax.transaction.Transaction lookupJeeTransaction() {
        try {
            ...
            throw new FlowLongException("无法从事务管理中获取事务对象["
    ...
    public static Object lookupFromJndi(String jndiName) {
        try {
            ...
            throw new FlowLongException("无法找到jndi名称[" + jndiName + "]\n"
                    + e.getMessage(), e);
        }
    }
    ...
    public static int getUserTransactionStatus(UserTransaction userTransaction) {
        ...
        try {
            ...
            throw new FlowLongException("无法获取事务状态:" + e.getMessage(), e);
        }
        return status;
    }
    ...
    public static boolean isRollbackOnly() {
        try {
            ...
            throw new FlowLongException("无法获取用户事务的状态" + e.getMessage(), e);
        }
    }
    ...
    public static void registerSynchronization(Synchronization synchronization) {
        try {
            ...
            throw new FlowLongException("couldn't register synchronization: "
                    + e.getMessage(), e);
        }
    }
    ...
    public static void begin() {
        try {
            ...
            throw new FlowLongException("couldn't begin transaction: "
                    + e.getMessage(), e);
        }
    }
    ...
    public static void rollback() {
        try {
            ...
            throw new FlowLongException("couldn't rollback: " + e.getMessage(), e);
        }
    }
    ...
    public static void commit() {
        try {
            ...
            throw new FlowLongException("couldn't commit: " + e.getMessage(), e);
        }
    }
    ...
    public static javax.transaction.Transaction suspend() {
        try {
            ...
            throw new FlowLongException("couldn't suspend: " + e.getMessage(), e);
        }
    }
    ...
    public static void resume(javax.transaction.Transaction transaction) {
        try {
            ...
            throw new FlowLongException("couldn't resume: " + e.getMessage(), e);
        }
    }
}
