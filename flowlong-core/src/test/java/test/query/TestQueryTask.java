...
import com.flowlong.bpm.engine.entity.WorkItem;
 ...
 * @since 1.0
 */
public class TestQueryTask extends TestLongBase {
    @Test
    public void test() {
        ...
        System.out.println(queryService.getWorkItems(new Page<WorkItem>(),
                new QueryFilter().setOperator("1").setInstanceId("36c0228fcfa740d5b62682dc954eaecd")));
    }
}
