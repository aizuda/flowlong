 ...
 * @since 1.0
 */
public class TestSurrogate extends TestLongBase {

    @Before
    public void before() {
        this.deployByResource("test/surrogate/process.long");
    }
    ...
    public void test() {
        ...
        Instance instance = engine.startInstanceByName("surrogate", 0, "2", args);
