 ...
 * @since 1.0
 */
public class TestAidant extends TestLongBase {
    @Before
    public void before() {
        this.deployByResource("test/task/aidant/process.long");
    }

    @Test
    public void test() {
        Instance instance = engine.startInstanceByName("aidant", 0);
        ...
        for (Task task : tasks) {
            ...
            engine.taskService().createNewTask(task.getId(), 1, "test");
        }
    }
}
