 ...
 * @since 1.0
 */
public class TestAssignment extends TestLongBase {
    @Before
    public void before() {
        this.deployByResource("test/task/assignmenthandler/process.long");
    }

    @Test
    public void test() {
        Instance instance = engine.startInstanceById(processId, "2");
