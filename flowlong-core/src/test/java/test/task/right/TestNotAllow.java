 ...
 * @since 1.0
 */
public class TestNotAllow extends TestLongBase {
    @Before
    public void before() {
        this.deployByResource("test/task/right/process.long");
    }
    ...
    public void test() {
        ...
        for (Task task : tasks) {
            engine.executeTask(task.getId(), FlowLongEngine.ADMIN, args);
        }
    }
}
